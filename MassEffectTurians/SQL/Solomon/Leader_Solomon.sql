...
SELECT	'LEADER_LEU_SOLOMON',		'LEADER_VICTUS_NEUTRAL.dds',		0,						'LEADER_VICTUS_BACKGROUND.dds'
WHERE EXISTS (SELECT * FROM Leu_Settings WHERE Type = 'LEU_SOLOMON' AND Value = 1);		
...
INSERT INTO Colors 
		(Type, 											Color)
VALUES	('COLOR_PLAYER_LEUGI_LEU_SOLOMON_BACKGROUND', 	'28,112,171,255'),
		('COLOR_PLAYER_LEUGI_LEU_SOLOMON_FOREGROUND', 	'245,235,220,255');
