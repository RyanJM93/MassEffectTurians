...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="C:\Users\lavag\Pictures\Turian Hierarchy\Victus\LEADER_VICTUS_BACKGROUND.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1513746833</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_VICTUS_BACKGROUND.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_VICTUS_BACKGROUND"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
