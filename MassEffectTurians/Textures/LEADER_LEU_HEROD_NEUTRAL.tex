...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="C:\Users\lavag\Pictures\Turian Hierarchy\IsraelTextures\LEADER_LEU_HEROD_NEUTRAL.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3223073392</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_LEU_HEROD_NEUTRAL.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_LEU_HEROD_NEUTRAL"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
